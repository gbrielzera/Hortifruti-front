  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Seção de cadastro */}
        <section className="text-center mb-8 bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">Ainda não é nosso cliente?</h2>
          <p className="text-gray-600 mb-4">Cadastre-se para receber nossas ofertas</p>
          <DefaultButton 
            texto="Cadastrar" 
            width={200} 
            height={50}
            className="bg-green-600 hover:bg-green-700 text-white mx-auto transition-colors"
          />
        </section>
